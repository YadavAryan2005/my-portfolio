...
function Services() {
  return (
    <div className='w-full   flex flex-col  rounded-xl p-2 pt-8 md:pt-2 pb-0 md:min-h-[98vh] min-h-[820px] justify-center '>
      <div className='max-w-[2000px] xl:px-[150px] md:px-[30px] lg:px-[90px] sm:px-[20px] justify-center items-center md:flex'>
        ...
        <div className='w-full md:w-1/2'>
          ...
          <div data-aos='fade-left' className='py-5'>
            <h1 className='kanit text-4xl font-bold  md:text-5xl lg:text-6xl'>
              1.Full Stack Web <br />
              Development
            </h1>
            <h2 className='float-end pt-3 text-slate-400 kanit'>Proficiency</h2>
            <h2 className='float-start pt-3 text-blue-500 kanit font-bold'>
              Advanced
            </h2>
          </div>
          <br />
          ...
          <hr data-aos='fade-left' className='Border border-slate-500' />
          <div data-aos='fade-left' className='py-5'>
            <h1 className='kanit text-4xl lg:Text-5xl font-bold lg:text-6xl'>
              3.Website UI/UX <br />
              Design
            </h1>
            <h2 className='float-end pt-3 text-slate-400 kanit'>Proficiency</h2>
